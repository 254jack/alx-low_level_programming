...
/**
 * close_file - a functiont that closes file descriptors.
 ...
 * @argc: args supplied to the obj
 * @argv: pointer array poiting args
 *
 * Return: 0
 *
 * Description: If the number of argument count is incorrect - exit code 97.
